    ...
    >
      ...
      >
        <div
          ...
          style={{ boxShadow: `0 0 24px -8px ${node.color}` }}
        >
...
export function DecisionLab() {
  return (
    <Section id="decisionlab">
      ...
      <BlurCircle color="rgba(59, 130, 246, 0.1)" size={500} className="left-[-8%] top-[25%]" duration={18} />
      <BlurCircle color="rgba(20, 217, 255, 0.08)" size={420} className="right-[-6%] bottom-[15%]" duration={20} delay={2} />
      ...
      <Container className="relative z-10">
        ...
        <Reveal delay={0.15} className="mt-14">
          <div className="relative overflow-hidden rounded-3xl glass-strong p-6 sm:p-10">
            <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#7c6dff]/50 to-transparent" />
